...
export type OrderQueryQuery = { __typename?: 'Query', order: { __typename?: 'Order', id: string, createdAt: any, status?: number | null, mode: string, user?: { __typename?: 'User', email: string, name: string } | null, pizzas: Array<{ __typename?: 'Pizza', id: string, name: string, size: string, sauce: string, cheeseAmount: string, crust: string, toppings: string }> } };
