...
const PIZZA_STATUS = [
  {
    ...
    description:
      "One of our Pizza Artists will be taking care of your order shortly!",
    averageTime: 2,
  },
  {
    displayText: "Prep",
  ...
  },
  {
    displayText: "Box",
    description:
      "Your pizza is being bundled up for travel in our signature boxes",
    averageTime: 2,
  },
];
...
export const CRUST = {
  ORIGINAL: {
    ...
    description:
      "Our house favorite, brushed with garlic butter -- you can't go wrong!",
    key: "ORIGINAL",
  },
  DEEP_DISH: {
    displayName: "Deep Dish",
    description:
      "Our famous, scrumptious, burnt cheese crust! You'll need a nap after",
    key: "DEEP_DISH",
  },
  THICC: {
    displayName: "THICC",
...
export const SAUCE = {
  MARINARA: {
    ...
    description:
      "Hearty red sauce, made with San Marzano tomatoes and fresh Italian herbs",
    key: "MARINARA",
  },
  ALFREDO: {
    displayName: "Alfredo",
    description:
      "Creamy white sauce, made with plenty of parmesan cheese and lots of love",
    key: "ALFREDO",
  },
  BBQ: {
    displayName: "BBQ",
    description:
      "Tangy mesquite barbecue sauce, perfect with grilled meats and veggies",
    key: "BBQ",
  },
  BUFFALO: {
    displayName: "Buffalo",
    description:
      "Spicy, zingy, neon orange buffalo sauce for the lover of hot wings",
    key: "BUFFALO",
  },
  NONE: {
...
export const TOPPINGS = {
  ...
  PINEAPPLE: {
    ...
    description:
      "Sweet, fresh tropical pineapple, never from a can -- cowabunga!",
    key: "PINEAPPLE",
  },
  BLACK_OLIVE: {
...
export const FAVORITES = [
  {
    ...
    description:
      "A classic you can't go wrong with! A balance of meats and veggies",
  ...
  },
  {
    displayName: "Bianca",
    description:
      "Our delicious fennel-studded sausage and green peppers on creamy alfredo",
    crust: CRUST.ORIGINAL,
    sauce: SAUCE.ALFREDO,
