...
const BYOCategory = ({ categoryName, categoryOptions }) => {
  return (
    <div
      className={`${styles["byo-category"]} ${
        categoryName === "Size" ? styles["byo-category-size"] : ""
      }`}
    >
      <h3>{categoryName}</h3>
      <ul>
        ...
        {FAVORITES.map((pizza) => {
          ...
          return (
            <li key={pizza.displayName} className={styles.card}>
              ...
              <p>
                <strong>Crust:</strong> {pizza.crust.displayName}
              </p>
              <p>
                <strong>Sauce:</strong> {pizza.sauce.displayName}
              </p>
              <p>
      ...
      <div className={styles.byo}>
        <div className={styles.wrapper}>
          <div className={styles.left}>
            ...
            <BYOCategory
              categoryName="Cheese Amount"
              categoryOptions={CHEESE_AMOUNT}
            />
